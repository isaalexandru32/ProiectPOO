...
public class Boxe extends Gadget {
    ...
    public static ArrayList<Boxe> cauta1(ArrayList<Boxe> lista, int optiune, String valoare) {
        ArrayList<Boxe> rezultate = new ArrayList<>();

        for (Boxe a : lista) {
            switch (optiune) {
                case 1:
                    if (a.getSubwoofer() == Boolean.parseBoolean(valoare)) {
                        rezultate.add(a);
                    }
                    break;
                case 2:
    ...
    public static void cauta(ArrayList<Boxe> lista, int optiune, String valoare) {
        boolean gasit = false;
        for (Boxe a : lista) {
            switch (optiune) {
                case 1:
